...
//        {
//            using (var context = new AbstractInstallationSoftwareDatabaseImplement())
//            {
...
//                .Include(rec => rec.PackageComponents)
//               .ThenInclude(rec => rec.Component)
//               .FirstOrDefault(rec => rec.ProductName == model.PackageName || rec.Id
//               == model.Id);
//                return product != null ?
...
//                    try
//                    {
//                        context.Packages.Add(CreateModel(model, new Package(), context));
//                        context.SaveChanges();
//                        transaction.Commit();
//                    }
//                    catch
...
//                    try
//                    {
//                        var element = context.Package.FirstOrDefault(rec => rec.Id ==
//                       model.Id);
//                        if (element == null)
//                        {
...
//       AbstractInstallationSoftwareDatabaseImplement context)
//        {
